 ...
 */
class DocumentsVoteHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        if (isset($data['keywordId'])) {
            $value = $data['keywordId'];
            $return = (string) $value;
            $this->class->reflFields['keywordId']->setValue($document, $return);
            $hydratedData['keywordId'] = $return;
        }
