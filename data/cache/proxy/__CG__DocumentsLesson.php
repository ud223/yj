 ...
 */
class Lesson extends \Documents\Lesson implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'name', 'description', 'photo', 'id', 'created_at', 'updated_at');
    }
