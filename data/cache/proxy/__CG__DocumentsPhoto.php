 ...
 */
class Photo extends \Documents\Photo implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'name', 'type', 'title', 'description', 'phototype', 'thumbnail', 'owner', 'status', 'scale', 'photoclass', 'id', 'created_at', 'updated_at');
    }
