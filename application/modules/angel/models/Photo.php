...
class Angel_Model_Photo extends Angel_Model_AbstractModel {
    ...
    public function savePhoto($id, $title, $description, $phototype, $photoclass) {
        $data = array("title" => $title, "description" => $description, "phototype" => $phototype, "photoclass"=>$photoclass);
    ...
    public function addPhoto($photo, $title, $description, $phototype, $thumbnail, $owner, $scale, $photoclass) {
        $result = false;
        $imageService = $this->_container->get('image');
