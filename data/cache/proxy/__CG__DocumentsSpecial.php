 ...
 */
class Special extends \Documents\Special implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addProgram($p);
    }

    public function clearProgram()
    {
        $this->__load();
        return parent::clearProgram();
    }
    ...
    {
        return array('__isInitialized__', 'name', 'authorId', 'photo', 'program', 'categoryId', 'id', 'created_at', 'updated_at');
    }
