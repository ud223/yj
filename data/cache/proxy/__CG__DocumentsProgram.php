 ...
 */
class Program extends \Documents\Program implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addPhoto($p);
    }

    public function clearPhoto()
    {
        $this->__load();
        return parent::clearPhoto();
    }

    public function addKeyword(\Documents\Keyword $p)
    {
        $this->__load();
        return parent::addKeyword($p);
    }

    public function clearKeyword()
    {
        $this->__load();
        return parent::clearKeyword();
    }
    ...
    {
        return array('__isInitialized__', 'name', 'sub_title', 'oss_video', 'oss_audio', 'author', 'duration', 'time', 'keyword', 'description', 'photo', 'status', 'owner', 'captions', 'id', 'created_at', 'updated_at');
    }
