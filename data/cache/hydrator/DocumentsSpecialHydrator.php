 ...
 */
class DocumentsSpecialHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        if (isset($data['authorId'])) {
            $value = $data['authorId'];
            $return = (string) $value;
            $this->class->reflFields['authorId']->setValue($document, $return);
            $hydratedData['authorId'] = $return;
        }
        ...
        /** @Many */
        $mongoData = isset($data['program']) ? $data['program'] : null;
        $return = new \Doctrine\ODM\MongoDB\PersistentCollection(new \Doctrine\Common\Collections\ArrayCollection(), $this->dm, $this->unitOfWork, '$');
        $return->setHints($hints);
        $return->setOwner($document, $this->class->fieldMappings['program']);
        $return->setInitialized(false);
        if ($mongoData) {
            $return->setMongoData($mongoData);
        }
