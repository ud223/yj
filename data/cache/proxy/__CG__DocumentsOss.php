 ...
 */
class Oss extends \Documents\Oss implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'name', 'description', 'status', 'key', 'fsize', 'type', 'ext', 'owner', 'id', 'created_at', 'updated_at');
    }
