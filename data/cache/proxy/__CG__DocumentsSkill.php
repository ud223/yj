 ...
 */
class Skill extends \Documents\Skill implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'name', 'photo', 'value', 'type', 'id', 'created_at', 'updated_at');
    }
