<?php
//header("location:http://www.yujiaqu.com/pay/success/". $this->order_id); exit;

ini_set('date.timezone','Asia/Shanghai');
error_reporting(E_ERROR);

require_once "/var/www/yj/public/lib/WxPay.Api.php";
require_once '/var/www/yj/public/lib/WxPay.Notify.php';
...
if ($result == "SUCCESS") {
    header("location:http://www.yujiaqu.com/paySuccess.php"); exit;
}
else {
    header("location:http://www.yujiaqu.com/paySuccess.php"); exit;
}
